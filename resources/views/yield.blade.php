...
<head>
  <meta charset="utf-8">
  <title>m3_auto ECommerse Website</title>
  <meta name="description" content="Modern ECommerse Website">
    ...
    <header class="header__section">
                ...
                <div class="main__header--inner d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="/">
                            <img loading="lazy" class="main__logo--img" src="assets/img/logo/nav-log.webp" alt="logo-img" lazy>
                        </a></h1>
                    </div>
                    <div class="header__menu d-none d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="header__menu--wrapper d-flex">
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="/shop">Accesories</a>  
                                </li>
                                        ...
                                        <ul class="header__mega--menu d-flex">
                                            <li class="header__mega--menu__li">
                                                <ul class="header__mega--sub__menu">
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/shop">Vitamins & Health</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/shop">Mans Collection</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/shop">Beauty products</a></li>
                                                </ul>
                                            </li>
                                            <li class="header__mega--menu__li">
                                                <ul class="header__mega--sub__menu">
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/shop">Variable Product</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/shop">Product Gallery</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/shop">Trending Product</a></li>
                                                </ul>
                                            </li>
                                            <li class="header__mega--menu__li">
                                                <ul class="header__mega--sub__menu">
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/my-account">My Account</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/cart">Cart</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/wishlist">Wishlist</a></li>
                                                    <li class="header__mega--sub__menu_li"><a class="header__mega--sub__menu--title" href="/checkout">Checkout</a></li>
                                                </ul>
                                            </li>
                                            <li class="header__mega--menu__li banner__child">
                                                <div class="header__mega--menu__banner">
                                                    <a href="/shop">
                                                        <img loading="lazy" class="header__mega--menu__banner--img" src="assets/img/banner/banner-menu.jpg" alt="banner">
                                                    </a>
                                                </div>
                                            </li>
                                        </ul>
                    ...
                    <div class="header__account">
                        <ul class="header__account--wrapper d-flex align-items-center">
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn d-sm-2-none" href="/wishlist">
                                    <span class="header__account--btn__icon">
                                        <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            @guest
                            <li class="header__account--items">
                                <a class="primary__btn" href="/register">Sign Up</a>
                            </li>
                            @endguest
                        </ul>
                    </div>                    
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="/">
                        <img loading="lazy" src="assets/img/logo/" alt="Logo-img" width="158" height="36">
                    </a>
                        ...
                        <li class="offcanvas__menu_li">
                            ...
                            <ul class="offcanvas__sub_menu">
                                <li class="offcanvas__sub_menu_li">
                                    <a href="#" class="offcanvas__sub_menu_item">Products</a>
                                    <ul class="offcanvas__sub_menu">
        ...
        <div class="offcanvas__sticky--toolbar">
            <ul class="d-flex justify-content-between">
                ...
                <li class="offcanvas__sticky--toolbar__list">
                    <a class="offcanvas__sticky--toolbar__btn" href="/wishlist">
                        <span class="offcanvas__sticky--toolbar__icon"> 
            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.html"><img loading="lazy" src="assets/img/product/small-product/product1.webp" alt="prduct-img"></a>
                    </div>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.html"><img loading="lazy" src="assets/img/product/small-product/product2.webp" alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                            ...
                            <div class="footer__widget--inner">
                                <div class="footer__logo">
                                    <a class="footer__logo--link" href="/">
                                        <img loading="lazy" class="footer__logo--img" src="assets/img/logo/nav-log.webp" alt="logo-img">
                                    </a>
                                </div>
        ...
        <div class="footer__bottom">
            <div class="container">
                <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                    <p class="copyright__content mb-0"><span class="text__secondary">© 2022</span>
                        @yield('home_copyright_content')
                    </p>
                    <div class="footer__payment">
                        <img loading="lazy" src="assets/img/icon/payment-img.webp" alt="payment-img">
                    </div>
                </div>
            </div>
        </div>
