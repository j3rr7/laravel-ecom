                                            ...
                                            <article class="product__card">
                                                <div class="product__card--thumbnail">
                                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                                        <img class="product__card--thumbnail__img product__primary--img" src="{{$product['image']}}" alt="product-img">
                                                        <img class="product__card--thumbnail__img product__secondary--img" src="{{$product['image']}}" alt="product-img">
                                                    </a>
                            ...
                            <nav class="pagination justify-content-center">
                                <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
                                    <li class="pagination__list">
                                        <a href="{{($page > 2) ? "/shop?page=" . ($page-1) : "/shop"}}" class="pagination__item--arrow  link ">
                                    ...
                                    <li>
                                    <li class="pagination__list"><a href="/shop?page=1" class="{{"pagination__item " . (($page == 1) ? "pagination__item--current" : "link")}} ">1</a></li>
                                    <li class="pagination__list"><a href="/shop?page=2" class="{{"pagination__item " . (($page == 2) ? "pagination__item--current" : "link")}} ">2</a></li>
                                    <li class="pagination__list"><a href="/shop?page=3" class="{{"pagination__item " . (($page == 3) ? "pagination__item--current" : "link")}} ">3</a></li>
                                    <li class="pagination__list"><a href="/shop?page=4" class="{{"pagination__item " . (($page == 4) ? "pagination__item--current" : "link")}} ">4</a></li>
                                    <li class="pagination__list">
                                        <a href="{{"/shop?page=" . ($page+1)}}" class="pagination__item--arrow  link ">
