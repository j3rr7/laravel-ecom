        ...
        tabContainer.addEventListener(
            "click", function (evt) {
                ...
                if (listItem.hasAttribute("data-toggle")) {
                    ...
                    getSiblings(targetItem).forEach(
                        function (pane) {
...
document.querySelectorAll("[data-countdown]").forEach(
    function (elem) {
...
function offcanvsSidebar(openTrigger, closeTrigger, wrapper)
{
    ...
    if (OpenTriggerprimary__btn && WrapperSidebar) {
        OpenTriggerprimary__btn.forEach(
            function (singleItem) {
                singleItem.addEventListener(
                    "click", function (e) {
...
function customAccordion(accordionWrapper, singleItem, accordionBody)
{
    ...
    accoridonButtons.forEach(
        function (item) {
            item.addEventListener(
                "click", function (evt) {
                    let itemTarget = evt.target;
                    if (itemTarget.classList.contains("accordion__items--button") 
                        ...
                        if (singleAccordionWrapper.classList.contains("active")) {
                            ...
                            getSiblings(singleAccordionWrapper).forEach(
                                function (item) {
...
const footerWidgetAccordion = function () {
    ...
    footerWidgetContainer?.addEventListener(
        "click", function (evt) {
            ...
            if (singleItemTarget.classList.contains("footer__widget--button")) {
                ...
                if (footerWidget.classList.contains("active")) {
                    ...
                    getSiblings(footerWidget).forEach(
                        function (item) {
...
window.addEventListener(
    "resize", function () {
        document.querySelectorAll(".footer__widget").forEach(
            function (item) {
